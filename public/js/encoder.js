JSNES.Encoder = function() {
  this.quality = 0;
  this.fround = Math.round;
  this.ffloor = Math.floor;
...
JSNES.Encoder.prototype = {
    initQuantTables: function(sf){
      ...
      initHuffmanTbl: function()
        ...
        {
            byteout.push(this.clt[value]); // write char directly instead of converting later
        },
        ...
        encode: function(image,quality,toRaw) // image data object
        {
